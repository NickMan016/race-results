                ...
                isLoad ? (
                    <Section title={RaceTable?.Races[0].raceName || ''} content={
                        <div className="relative grid grid-cols-2">
                            ...
                            <img className="block my-4 mx-auto h-[150px] col-span-2 sm:my-0 sm:col-span-1" src={`https://race-results-api.onrender.com/api/circuits/${RaceTable?.Races[0].Circuit.circuitId}/image`} alt="" />
                        </div>
                    } />
                ) : (
                    <SectionLoading />
